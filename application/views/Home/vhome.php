  ...
  <div class="main">
    <div class="container">              
        ...
        <div class="tab-content margin-bottom-30 ">
          <div class="tab-pane row fade in active">
            <div class="col-md-12 col-xs-12">
              ...
              <a href="<?php echo base_url().'';?>"><blockquote>Download e-book panduan program internship</blockquote></a>
            </div>
          </div>
        </div>           
      </div>
      ...
      <div class="col-md-8 col-xs-12 pull-right">
        ...
        <div class="row quote-v1 survey ">
          <div class="col-md-6 ">
            <span><i class="fa fa-globe"></i> KONTAK KAMI</span>
           </div>
        </div>
        <!-- ISI KONTEN -->
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-xs-8">
                <address class="contact">
                  ...
                  Jl. Veteran Gresik, 6122 Jawa Timur Indonesia
                  </br>
                  <span><i class="fa fa-phone"></i></span> Phone: 031-3981732
                  </br>
                  <span><i class="fa fa-fax"></i></span> Fax: 031-3983209, 3972264
                  </br>
                  <span><i class="fa fa-envelope-o"></i></span> Email:<a href="mailto:diklat.sg@semenindonesia.com"> diklat.sg@semenindonesia.com</a>
                  </br>
                  <span><i class="fa fa-globe"></i></span> Website:<a href="www.semengresik.com">www.semengresik.com</a>
                </address> 
              </div>
              <!-- END OF DATA CONTACT  -->
